...
/**
 * Returns ECharts option for a demo gauge chart (used as fallback for unknown source types).
 *
...
/**
 * Returns ECharts option for a demo polar line chart (used as error fallback for script source).
 *
 * @returns {object} ECharts option object
 */
function demoChart() {

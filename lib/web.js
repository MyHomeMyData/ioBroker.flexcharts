...
class ExtensionFlexcharts {
    ...
    constructor(server, webSettings, adapter, instanceSettings, app) {
        ...
        this.strThemeV5Dark =
            'var dark_colorPalette=["#4992ff","#7cffb2","#fddd60","#ff6e76","#58d9f9","#05c091","#ff8a45","#8d48e3","#dd79ff"],dark_contrastColor="#B9B8CE",dark_backgroundColor="#100C2A",dark_axisCommon=function(){return{axisLine:{lineStyle:{color:dark_contrastColor}},splitLine:{lineStyle:{color:"#484753"}},splitArea:{areaStyle:{color:["rgba(255,255,255,0.02)","rgba(255,255,255,0.05)"]}},minorSplitLine:{lineStyle:{color:"#20203B"}}}},dark_theme={darkMode:!0,color:dark_colorPalette,backgroundColor:dark_backgroundColor,axisPointer:{lineStyle:{color:"#817f91"},crossStyle:{color:"#817f91"},label:{color:"#fff"},handle:{shadowBlur:3,shadowOffsetX:0,shadowOffsetY:2}},legend:{top:0,bottom:null,itemGap:10,textStyle:{color:dark_contrastColor}},textStyle:{color:dark_contrastColor},title:{left:0,top:0,textStyle:{color:"#EEF1FA"},subtextStyle:{color:"#B9B8CE"}},toolbox:{iconStyle:{borderColor:dark_contrastColor},padding:5,itemGap:8},dataZoom:{defaultLocationEdgeGap:7,borderRadius:3,borderColor:"#71708A",textStyle:{color:dark_contrastColor},brushStyle:{color:"rgba(135,163,206,0.3)"},handleStyle:{color:"#353450",borderColor:"#C5CBE3"},moveHandleStyle:{color:"#B0B6C3",opacity:.3},fillerColor:"rgba(135,163,206,0.2)",emphasis:{handleStyle:{borderColor:"#91B7F2",color:"#4D587D"},moveHandleStyle:{color:"#636D9A",opacity:.7}},dataBackground:{lineStyle:{color:"#71708A",width:.5},areaStyle:{color:"#71708A",opacity:.2}},selectedDataBackground:{lineStyle:{color:"#87A3CE",width:.5},areaStyle:{color:"#87A3CE",opacity:.2}}},visualMap:{textStyle:{color:dark_contrastColor},padding:5},timeline:{padding:5,itemStyle:{borderWidth:1},lineStyle:{color:dark_contrastColor},label:{color:dark_contrastColor},checkpointStyle:{borderWidth:2,shadowBlur:2,shadowOffsetX:1,shadowOffsetY:1},controlStyle:{color:dark_contrastColor,borderColor:dark_contrastColor,playIcon:"path://M31.6,53C17.5,53,6,41.5,6,27.4S17.5,1.8,31.6,1.8C45.7,1.8,57.2,13.3,57.2,27.4S45.7,53,31.6,53z M31.6,3.3 C18.4,3.3,7.5,14.1,7.5,27.4c0,13.3,10.8,24.1,24.1,24.1C44.9,51.5,55.7,40.7,55.7,27.4C55.7,14.1,44.9,3.3,31.6,3.3z M24.9,21.3 c0-2.2,1.6-3.1,3.5-2l10.5,6.1c1.899,1.1,1.899,2.9,0,4l-10.5,6.1c-1.9,1.1-3.5,0.2-3.5-2V21.3z",stopIcon:"path://M30.9,53.2C16.8,53.2,5.3,41.7,5.3,27.6S16.8,2,30.9,2C45,2,56.4,13.5,56.4,27.6S45,53.2,30.9,53.2z M30.9,3.5C17.6,3.5,6.8,14.4,6.8,27.6c0,13.3,10.8,24.1,24.101,24.1C44.2,51.7,55,40.9,55,27.6C54.9,14.4,44.1,3.5,30.9,3.5z M36.9,35.8c0,0.601-0.4,1-0.9,1h-1.3c-0.5,0-0.9-0.399-0.9-1V19.5c0-0.6,0.4-1,0.9-1H36c0.5,0,0.9,0.4,0.9,1V35.8z M27.8,35.8 c0,0.601-0.4,1-0.9,1h-1.3c-0.5,0-0.9-0.399-0.9-1V19.5c0-0.6,0.4-1,0.9-1H27c0.5,0,0.9,0.4,0.9,1L27.8,35.8L27.8,35.8z",nextIcon:"M2,18.5A1.52,1.52,0,0,1,.92,18a1.49,1.49,0,0,1,0-2.12L7.81,9.36,1,3.11A1.5,1.5,0,1,1,3,.89l8,7.34a1.48,1.48,0,0,1,.49,1.09,1.51,1.51,0,0,1-.46,1.1L3,18.08A1.5,1.5,0,0,1,2,18.5Z",prevIcon:"M10,.5A1.52,1.52,0,0,1,11.08,1a1.49,1.49,0,0,1,0,2.12L4.19,9.64,11,15.89a1.5,1.5,0,1,1-2,2.22L1,10.77A1.48,1.48,0,0,1,.5,9.68,1.51,1.51,0,0,1,1,8.58L9,.92A1.5,1.5,0,0,1,10,.5Z",borderWidth:1}},calendar:{itemStyle:{color:dark_backgroundColor},dayLabel:{margin:"50%",color:dark_contrastColor},monthLabel:{margin:5,color:dark_contrastColor},yearLabel:{margin:30,color:dark_contrastColor}},timeAxis:dark_axisCommon(),logAxis:dark_axisCommon(),valueAxis:dark_axisCommon(),categoryAxis:(()=>{const o=axisCommon();return o.axisTick={show:!0},o})(),bar:{defaultBarGap:"20%",select:{itemStyle:{borderWidth:1}}},funnel:{bottom:60,select:{itemStyle:{borderWidth:1}}},line:{symbolSize:4,symbol:"circle"},pictorialBar:{select:{itemStyle:{borderWidth:1}}},pie:{radius:[0,"75%"],labelLine:{length2:15}},treemap:{left:"center",top:"middle",width:"80%",height:"80%",scaleLimit:{max:null,min:null},breadcrumb:{top:"bottom",bottom:null}},graph:{color:dark_colorPalette},gauge:{title:{color:dark_contrastColor}},candlestick:{itemStyle:{color:"#FD1050",color0:"#0CF49B",borderColor:"#FD1050",borderColor0:"#0CF49B"}}};dark_theme.categoryAxis.splitLine.show=!1,echarts.registerTheme("dark",dark_theme);';
                                            ...
                                            if (result.error) {
                                                ...
                                                if (result && result == 'Error: Timeout exceeded') {
                                                    ...
                                                    if (queryThemeV5) {
                                                        ...
                                                        content = this.applyUserFunctions(content, this.strThemeV5Dark);
                                                    }

/*
    ...
    Theme light and dark as definied at version 5.6.0

    Based on v5.js (as default theme) provided by Apache ECharts

    Light (v5.js for default theme):
    Ref. https://github.com/apache/echarts/blob/master/theme/v5.js
...
// @ts-ignore
echarts.registerTheme('default', light_theme);
...
var dark_theme = {
    ...
    dataZoom: {
        ...
        dataBackground: {
            ...
            areaStyle: {
                color: '#71708A',
                opacity: 0.2    // set in light theme
            }
        },
        selectedDataBackground: {
            lineStyle: {
